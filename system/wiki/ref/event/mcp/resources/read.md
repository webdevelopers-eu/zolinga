...
| Field         | Type   | Notes |
|---------------|--------|-------|
| `params.uri`  | `string` | Required. The resource URI (e.g. `mcp-system:ipdefender:about.md`). |
...
curl -X POST https://your-host/mcp \
  ...
  -d '{"jsonrpc":"2.0","id":2,"method":"resources/read","params":{"uri":"mcp-system:ipdefender:about.md"}}'
```
...
```json
{
  ...
  "result": {
    "contents": [
      {
        "uri": "mcp-system:my-module:logo.png",
        "mimeType": "image/png",

...
| Field         | Type   | Notes |
|---------------|--------|-------|
| `uri`         | `string` | External URI in `mcp-system://<module>/resources/<basename>` format. |
...
```json
{
  ...
  "result": {
    "resources": [
      {
        "uri": "mcp-system://ipdefender/resources/about.md",
        "name": "about.md",
...
class MyResourcesListHandler implements ListenerInterface
{
    ...
    {
        $event->add(
            uri: 'mcp-system://my-module/resources/dynamic-resource',

...
| Field         | Type   | Notes |
|---------------|--------|-------|
| `params.uri`  | `string` | Required. The resource URI (e.g. `mcp-system://ipdefender/resources/about.md`). |
...
curl -X POST https://your-host/mcp \
  ...
  -d '{"jsonrpc":"2.0","id":2,"method":"resources/read","params":{"uri":"mcp-system://ipdefender/resources/about.md"}}'
```
...
```json
{
  ...
  "result": {
    "contents": [
      {
        "uri": "mcp-system://my-module/resources/logo.png",
        "mimeType": "image/png",

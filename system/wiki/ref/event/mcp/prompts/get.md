...
| Field             | Type   | Notes |
|-------------------|--------|-------|
| `params.name`     | `string` | Required. The prompt identifier (e.g. `mcp-system://ipdefender/prompts/trademark-search`). |
...
curl -X POST https://your-host/mcp \
  ...
  -d '{"jsonrpc":"2.0","id":2,"method":"prompts/get","params":{"name":"mcp-system://ipdefender/prompts/trademark-search","arguments":{"query":"ACME"}}}'
```

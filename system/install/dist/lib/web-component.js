...
export default class WebComponent extends HTMLElement {
     ...
     * @returns {Promise} - Promise that resolves when the content is loaded and all scripts and styles are ready.
     ...
     * @returns {Promise<Array>} - A promise that resolves when all scripts have been executed.
     */
     ...
     * @param {number} [timeout=30000] - The timeout duration in milliseconds.
     * @returns {Promise<void>} - A promise that resolves when the element is loaded successfully.

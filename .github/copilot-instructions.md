...
* When translating single words for which translator needs context, note the context by prepending it to translatable string with `"\x04"` separator. E.g. `dgettext('zolinga-intl', "Confirm form submission\x04Send")`
